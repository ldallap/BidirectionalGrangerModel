...
/*Good try*/
// #define gSR 3.4 ou 3.55
// #define gRS 0.2 ou 0.23


#define gEPoisson 0.6 //ns
#define totaltime 1000000
#define transient 40000
...
int main(int argc, char *argv[]){
  ...
  double RPoissonReceiver=(double) 3.0;
  ...
  // sprintf(datamempotential,"MeanMemPot_gIR_%.2lf_gSR_%.2lf_RateReceiver_%.3lf_seed_%ld.mp",gIR,gSR,RPoissonReceiver,seed);
  // sprintf(datamempotential,"FeedBackFeedForward_MeanMemPot_gES%.3lf_gIS%.3lf_gER%.3lf_gIR%.3lf_gSR%.3lf_gRS%.3lf_.mp",gES,gIS,gER,gIR,gSR,gRS);
  ...
  /*&&*/const double poisson_receiver=(1.0-exp(-RPoissonReceiver*dt));
  /*&&*/int spikes_R[500];
  /*&&*/int spikes_S[500];
  /*&&*/
